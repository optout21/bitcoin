...
constexpr int AVALANCHE_TRIALS = 2000;
...
static void Avalanche_XorHasher6x8_1(benchmark::Bench&)
{
    FastRandomContext rng{/*fDeterministic=*/true};
    PresaltedXorHasher6x8_1 hasher(rng.rand64());
    const auto stats{ComputeAvalancheStats(rng, AVALANCHE_TRIALS, [&](const uint256& v, uint32_t e) { return hasher(v, e); })};
    PrintAvalancheReport("PresaltedXorHasher6x8_1", stats);
}
...
BENCHMARK(Avalanche_XorHasher6x8_1);
